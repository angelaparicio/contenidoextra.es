...
/* Generated from /homepages/9/d377857919/htdocs/meneame/www/templates/sneak/base.html */
function haanga_fa2b9cdf09c22733abbe36297a617bab69e7fe70($vars, $return=FALSE, $blocks=array())
{
...
var sneak_base_url = \''.$globals['base_url'].'backend/sneaker2.php\';
	...
	switch (data.type) {
		case \'post\':
			...
			if (data.icon != undefined && data.icon.length > 0) {
				html += \'<a target="_blank" href="\'+base_url+\'user.php?login=\'+data.who+\'"><img src="\'+data.icon+\'" width=20 height=20 class="tooltip u:\'+data.uid+\'"/><\\/a>\';
			}
...
<script type="text/javascript" src="http://'.$globals['server_name'].$globals['base_url'].'js/sneak.js.php?'.$globals['sneak_version'].'" charset="utf-8"></script>
<script type="text/javascript">
';
