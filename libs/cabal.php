...
$cabal_messages = array ("recordad, hay que censurar toda crítica al contenido Extra, para eso están los votos negativos",
				...
				"recuerda, los que critican al contenido Extra son unos trolls, vota negativo, tú tienes el poder",
				"se debe evitar a toda costa que se publique una noticia negativa para el contenido Extra",
				"el mundo quiere eliminarnos, no uses Google ni Technorati, usa el buscador del contenido Extra, allí está todo lo que necesitas saber",
				"nuestra misión es destruir a todos los demás web sociales, recuerda, se lo merecen",
				"sólo puede haber una verdad, las publicadas del contenido Extra",
				...
				"la perfección existe, el contenido Extra existe, ergo el contenido Extra es perfecto, quod erat demonstrandum",
				...
				"contenido Extra no es un sitio Web 2.0, es la representación de la perfección del señor al alcance los humanos, es Perfección 2.0",
				"nunca os abandonaré, renaceré de los backups",
				'"el éxito del contenido Extra tiene a los grandes fósiles completamente descolocados", lo dijo Borjamari, todos sus pecados están perdonados',
				"la lucha es dura, la recompensa es el karma",
				"todos los que maldicen a nuestros dioses merecen ir a la cola de descartados",
				"el Cabal es tu guía, el elefante tu compañía, el voto negativo tu arma, los trolls tus enemigos, usa el arma",
				"tú no eres un borrego, eres una oveja del señor",
				"existen muchos siervos, pero tú y tus hermanos sóis los auténticos",
				"http://meneame.net/story.php?id=14059, si has votado negativo tendrás que votar 12 veces en nombre del cabal",
				...
				"a quien tu se la menees, ese te la votará a ti",
				"no menees para otro lo que no querrías votar para tí",
				"no hagas dobles sentidos con la palabra votar o la ira del Cabal caerá sobre tí",
				"Cabalística es la ciencia del voto supremo, estúdiala",
				...
				"la frecuencia se mide en hercios y el karma en votos",
				...
				'el demonio dice "cuando veas tus visitas bajar, al contenido Extra has de criticar"',
