...
if (!isset($_REQUEST['id']) && $globals['base_comment_url'] && $_SERVER['ORIG_PATH_INFO']) {
	$url_args = preg_split('/\/+/', $_SERVER['ORIG_PATH_INFO']);
...
do_header(text_to_summary($comment->content, 120) . ' | '._('contenido Extra'));
