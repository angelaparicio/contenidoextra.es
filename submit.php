...
function do_submit1() {
	...
	$url_title_aux = explode(' - ', $link->url_title);
	$url_title_aux = explode(' | ', $url_title_aux[0]);
	$url_title_aux = explode(' : ', $url_title_aux[0]);
	$link->url_title = $url_title_aux[0];
	...
	$link->tags = substr($link->tags, 0, strlen($link->tags)-2 );
