...
if ($_REQUEST['q']) {
	...
	$title = _('contenido Extra').': '._('búsqueda en comentarios') . ': ' . htmlspecialchars(strip_tags($_REQUEST['q']));
	...
	$title = _('contenido Extra').': '._('comentarios') . " [$id]";
	$globals['redirect_feedburner'] = false;
	...
	$title = _('contenido Extra').': '.sprintf(_('comentarios de %s'), $username);
	$globals['redirect_feedburner'] = false;
	...
	$title = _('contenido Extra').': '.sprintf(_('conversación de %s'), $username);
	$globals['redirect_feedburner'] = false;
	...
	$title = _('contenido Extra').': '.sprintf(_('comentarios noticias de %s'), $username);
	$globals['redirect_feedburner'] = false;
	...
	$title = _('contenido Extra').': '.sprintf(_('respuestas a %s'), $username);
	$globals['redirect_feedburner'] = false;
} else {
	//
	// All comments
	...
	$title = _('contenido Extra').': '._('comentarios');
	$globals['redirect_feedburner'] = false;
}
