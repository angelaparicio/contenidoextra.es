<?
	...
	do_header(_('FAQ') . ' | ' . _('contenido Extra'));
	$q = 1;
?>
<div id="singlewrap">
...
También encontrarás más información, dudas, recomendaciones en el <a href="http://meneame.wikispaces.com/" title="wiki meneame">wiki del contenido Extra</a>.
</p>
</li>
...
<p>Una herramienta de comunicación entre los usuarios de contenido Extra y se organiza en pequeños apuntes, como los mini-post de un blog colectivo --de todos los usuarios de nótame-- y a la vez individual.	Puedes usarlo para cuestiones relacionadas con contenido Extra o para explicar lo que quieras.	Puedes escribir desde el web, mensajería instantánea o el movil.  Encontrarás <a href="http://meneame.wikispaces.com/N%C3%B3tame">más detalles en el wiki</a>.</p>
</li>

<li id="<? echo "q$q";$q++;?>">
<h4>¿Qué es la fisgona?</h4>
<p>Muestra lo que sucede en contenido Extra en tiempo real.  Si eres usuario registrado también puedes usarla para chatear.</p>
</li>
...
<li id="<? echo "q$q";$q++;?>">
<h4><a name="we"></a>¿Quién está detrás del contenido Extra?</h4>
...
<p>Está explicado en  el apunte <a href="http://mnm.uib.es/gallir/posts/2005/12/08/535/"><em>¿Qué y porqué el contenido Extra?</em></a> del blog de Ricardo Galli.</p>
</li>
...
<p>De todas formas el objetivo del contenido Extra es distinto. No sólo se dan cuenta los que pueden votar anónimamente, también los autores de los apuntes enlazados que reciben notificación inmediata (<em>trackbacks</em>) y especialmente los autores que envían historias. Estos últimos notan las diferencias fundamentales, y cómo está todo pensado para facilitar el <em>votos</em> de blogs más que de sitios genéricos.</p>

<p>El objetivo fundamental y diferencias con Digg están explicadas en <a href="http://mnm.uib.es/gallir/posts/2005/12/08/535/"><em>¿Qué y porqué el contenido Extra?</em></a></p>
</li>
...
<li>La publicación de la noticia no sólo está basada en los votos (votos), sino en el valor del karma de los usuarios que han votado.</li>
...
<li id="<? echo "q$q";$q++;?>">
<h4>¿Dónde podemos seguir la evolución de los cambios al contenido Extra?</h4>
...
<p>El logo y el nombre Menéame es Marca Registrada de Menéame Comunicacions S.L. Para más información, consulta al <a href="http://blog.meneame.net">blog</a> o al <a href="http://meneame.wikispaces.com/" title="wiki meneame">wiki del contenido Extra</a>.</p>
