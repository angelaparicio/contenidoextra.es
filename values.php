...
do_header(_('Información sobre valores de karma y límites') . ' | ' . _('contenido Extra'));
...
echo '
		<fieldset id="comments">
			<legend>'._('comentarios').'</legend>
				...
				<br/>
				'._("Límite de comentarios por voto") . ': ' . $globals['max_comments'] . '<br/>
				<br/>
				'._("Tiempo que permanecen abiertos los comentarios en votos en portada") . ': ' . print_time($globals['time_enabled_comments']) . '<br/>
				<br/>
				'._("Tiempo que permanecen abiertos los comentarios en votos pendientes") . ': ' . print_time($globals['time_enabled_comments_status']['queued']) . '<br/>
				<br/>
				'._("Tiempo que permanecen abiertos los comentarios en votos descartados") . ': ' . print_time($globals['time_enabled_comments_status']['discard']) . '<br/>
				<br/>
				'._("Tiempo que permanecen abiertos los comentarios en votos autodescartados") . ': ' . print_time($globals['time_enabled_comments_status']['autodiscard']) . '<br/>
				<br/>
				'._("Tiempo que permanecen abiertos los comentarios en votos descartados por abuso") . ': ' . print_time($globals['time_enabled_comments_status']['abuse']) . '<br/>
				<br/>
...
echo '
		<fieldset id="links">
			<legend>'._('envíos').'</legend>
				'._("Límite de envíos global para usuarios con karma") . ' &lt;= ' . $globals['limit_3_minutes_karma'] . ' ('. _('se han enviado demasiadas historias en los últimos 3 minutos') ."): " . $globals['limit_3_minutes'] . ' ' . _("votos cada 3 minutos") . '<br/>
				<br/>
